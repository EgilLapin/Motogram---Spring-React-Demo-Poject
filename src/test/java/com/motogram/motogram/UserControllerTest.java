...
public class UserControllerTest {
    ...
    @Test
    public void postUser_whenUserHasNullPassword_receiveGenericMessageOfNullErrorForUsername(){
        User user = new User();
        user.setPassword(null);
        ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
        Map<String, String> validationErrors = response.getBody().getValidationErrors();
    ...
    @Test
    public void postUser_whenUserHasInvlaidLengthUsername_receiveGenericMessageOfSizeError(){
        User user = new User();
        user.setUsername("abc");
        ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
        Map<String, String> validationErrors = response.getBody().getValidationErrors();
    ...
    @Test
    public void postUser_whenUserHasInvalidPasswordPattern_receiveGenericMessageOfNullErrorForUsername(){
        User user = new User();
        user.setPassword("alllowercase");
        ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
        Map<String, String> validationErrors = response.getBody().getValidationErrors();
        assertThat(validationErrors.get("password")).isEqualTo("Password much have at least one uppercase, one lower case and one number");
    }
    ...
    @Test
    public void postUser_whenAnotherUserHasSameUsername_receiveMessageofDublicateUsername(){
        userRepository.save(createValidUser());
        User user = createValidUser();
        ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
        Map<String, String> validationErrors = response.getBody().getValidationErrors();
